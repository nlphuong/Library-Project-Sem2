                      ...
                      <div class="carousel-inner">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/images.jfif" alt=""></div>
                                        <div class="img-text">
                                            <h2>Emma Watson</h2>
                                ...
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/01.jfif" alt=""></div>
                                        <div class="img-text">
                                            <h2>Bill Gate</h2>
                                ...
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/download.jfif" alt=""></div>
                                        <div class="img-text">
                                            <h2>Steve Jobs</h2>
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/04.jfif" alt=""></div>
                                        <div class="img-text">
                                ...
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/05.jfif" alt=""></div>
                                        <div class="img-text">
                                            <h2>Jeff Bezos</h2>
                                ...
                                <div class="col-md-4">
                                    <div class="single-box">
                                        <div class="img-area"><img src="{{asset('images')}}/06.jfif" alt=""></div>
                                        <div class="img-text">
                                            <h2>Donald Trump</h2>
